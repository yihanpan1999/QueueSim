...
#        self.scheduled_revisit_time = None # the simulator will tell a prediction time to revisit
        ...
        self.checklist =  [] # check items to be done in the future (do not include the check items which have been done)
    ...
    # when to revisit, based on the prediction time and actual time when he/she completes all check items
